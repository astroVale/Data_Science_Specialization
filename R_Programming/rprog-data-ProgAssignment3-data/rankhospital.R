rankhospital <- function(state, outcome, num = "best") {
        # state argument indicates the 2-character abbreviated name of a state
        # outcome argument indicates either heart attack, heart failure, or pneumonia 
        # num argument indicates the ranking of a hospital in that state for the given outcome (either the best state, worst state, or an integer)
