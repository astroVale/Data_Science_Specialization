...
The **mean** and the **median** of the total number of steps taken per day are **`r total_mean`** and **`r total_median`**, respectively.  
...
The result of this computation tells us that the 5-minute interval that contains the maximum of steps is **`r max_interval`**.
...
This gives us the total number of NAs of **`r NA_count`**.
...
The **mean** and the **median** of the total number of steps taken per day are now **`r total_mean_new[1]`** and **`r total_median_new`**, respectively, with the imputed NA values.  
